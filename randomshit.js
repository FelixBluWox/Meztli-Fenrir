parcelRequire=function(e,r,t,n) {
    ...
    function f(t,n) {
        if(!r[t]){if(!e[t]) {
            ...
            if(!n&&i)return i(t,!0);if(o)return o(t,!0);
        ...
        var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;
        function p(e){
    ...
    },f.modules=e,f.cache=r,f.parent=o,
    ...
    "TCu9":[function(require,module,exports) {
        ...
        function t(e,t){
            for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}
        }
        function r(e,r,a){
        ...
        var a=function(){
            function t(r,a){e(this,t);var n=r.width,i=r.height,o=document.createElement("canvas");o.width=n,o.height=i;var u=o.getContext("2d");u.drawImage(r,0,0),this.canvas=o,this.context=u,this.frames=a}return r(t,[{key:"drawFrame",value:function(e,t,r,a,n,i){var o=this.frames[t],u=o.x,s=o.y,c=o.width,h=o.height;r|=0,a|=0,n|=c,i|=h,e.drawImage(this.canvas,u,s,c,h,r,a,n,i)}}]),t
        }();
        a.GeometryHorizontalLinear=function(e,t,r){
            for(var a=[],n=0;n<r;n+=1){
                ar i={x:e*n,y:0,width:e,height:t};a.push(i)
            }
            return a
        };
    ...
    "LeK6":[function(require,module,exports) {
        ...
        Object.defineProperty(exports,"__esModule",{value:!0}),exports.floatValue=t,exports.integerValue=r,exports.color=o;
    },{}],
